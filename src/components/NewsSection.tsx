...
const news = [
  {
    date: '2025.12.03',
    tag: 'News',
    title: '2025년 유망중소기업 인증',
    desc: '경제도시 대전을 이끌어갈 유망 중소기업으로 (주)코이션이 선정되어 2030년 12월 2일까지 유망 중소기업으로서 인증과 함께 대전광역시로부터 다양한 지원 수혜.',
  },
  {
    date: '2023.06.30',
    tag: 'News',
    title: '주식회사 코이션 지역 버스 광고 진행',
    desc: '대전광역시 소재 전문 기업으로서 지역사회에 코이션의 이름을 알리고 기술력을 홍보하고자 대전광역시 주요 시내버스에 대대적인 코이션 홍보를 진행.',
  },
  {
    date: '2023.05.31',
    tag: 'News',
    title: '대전광역시 "좋은 일터" 조성 우수기업 선정',
    desc: '코이션은 2023 좋은 일터 조성사업 약속 사항 선포식과 2022 좋은 일터 우수기업 인증식에서 근로환경 개선 성과로 우수기업으로 선정되어 수상 및 인증을 받았습니다.',
  },
  {
    date: '2022.11.01',
    tag: 'News',
    title: '대전 LoRa기반 돌보 알리미 서비스 오픈',
    desc: '(주)코이션은 대전시 지원사업으로 AI, 데이터 기반 대전시 하천 내 시설물 정보 서비스를 개발하고 시민 편의 서비스를 제공합니다.',
  },
]
    ...
    <section id="news" style={{ background: '#0a0a0a', padding: '100px 32px', position: 'relative', zIndex: 2 }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1px', background: 'rgba(255,255,255,0.06)' }} className="news-grid">
          {news.map((item, i) => (
            <FadeUp key={i} delay={i * 0.08} style={{
              padding: '36px', background: '#0a0a0a',
